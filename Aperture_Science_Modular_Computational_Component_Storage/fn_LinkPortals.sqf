...
_bPortal setObjectTexture [1, format[ASHPD_BLUE_PIP_TEX, _owner]];
missionNameSpace setVariable [format["ASHPD_VAR_BCAM%1", _owner], "camera" camCreate ASHPD_DISABLED_POS];
...
_oPortal setObjectTexture [1, format[ASHPD_ORANGE_PIP_TEX, _owner]];  
missionNameSpace setVariable [format["ASHPD_VAR_OCAM%1", _owner], "camera" camCreate ASHPD_DISABLED_POS];
